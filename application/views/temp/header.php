...
<head>
    ...
    <title>Sistema de Inspecci&oacute;n - Elev&eacute;</title>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>/assets/css/bootstrap.min.css" integrity="" crossorigin="">
	...
	<!--<script async src="<?php echo base_url();?>assets/scripts/js.js?id=UA-166663376-1"></script>
	<script>
