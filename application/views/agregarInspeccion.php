		...
		<div id="filtros" class="mt-3 mr-3 ml-3">
			<form id="agregarInspeccion" action="agregarInspeccion" method="POST" enctype="multipart/form-data">
				<div class="row">
					...
					<!--<input type="text" class="form-control form-control-sm" id="inputEsTemporal" name="inputEsTemporal" value="<?php #if(isset($inspeccion['es_temporal'])): echo $inspeccion['es_temporal']; endif; ?>" hidden>-->
					<input type="text" class="form-control form-control-sm" id="es_reinspeccion" name="es_reinspeccion" value="<?php if(isset($inspeccion['reinspeccion'])): echo $inspeccion['reinspeccion']; endif; ?>" hidden>
				</div>
				...
				<div class="row">
					...
					<div class="form-group col-sm-6">
						<label for="inputTecnico">T&eacute;cnico de Apoyo</label>
						<input type="text" class="form-control  form-control-sm" id="inputTecnico" minlength="1" placeholder="Ingrese Nombre del Tecnico de Apoyo" name="inputTecnico" value="<?php if(isset($inspeccion['nombre_tecnico'])): echo $inspeccion['nombre_tecnico']; endif; ?>" >
					</div>

					<div class="form-group col-sm-6">
						<label for="inputCantAscensor">Cantidad de Ascensores</label>
						<input type="text" class="form-control  form-control-sm" id="inputCantAscensor" minlength="1" placeholder="Ingrese Cantidad de Ascensores" name="inputCantAscensor" value="<?php if(isset($inspeccion['cantidad_ascensor'])): echo $inspeccion['cantidad_ascensor']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
					</div>
				</div>
					...
					<div class="col-sm-12 mb-5">
						...
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<input type="text" class="form-control  form-control-sm" id="inputNombreE" minlength="1" placeholder="Ingrese Nombre del Edificio" name="inputNombreE" value="<?php if(isset($inspeccion['edificio'])): echo $inspeccion['edificio']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
								<!--<span>Se requiere un Nombre de Equipo.</span>-->
							</div>
							<div class="form-group col-sm-6">
								<label for="inputDireccionE">Direccion del Edificio</label>
								<input type="text" class="form-control  form-control-sm" id="inputDireccionE" minlength="1" placeholder="Ingrese Direccion del Edificio" name="inputDireccionE" value="<?php if(isset($inspeccion['domicilio'])): echo $inspeccion['domicilio']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
								<!--<span>Se requiere un Nombre de Equipo.</span>-->
							</div>
						</div>
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<input type="text" class="form-control  form-control-sm" id="inputRutE" minlength="1" placeholder="Ingrese un Rut del Edificio" name="inputRutE" value="<?php if(isset($inspeccion['rut_e'])): echo $inspeccion['rut_e']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
								<!--<span>Se requiere un Nombre de Equipo.</span>-->
							</div>
							<div class="form-group col-sm-6">
								<label for="inputIdE">Id de Ascensor</label>
								<input type="text" class="form-control  form-control-sm" id="inputIdE" minlength="1" placeholder="Ingrese un Id de Ascensor" name="inputIdE" value="<?php if(isset($inspeccion['rol'])): echo $inspeccion['rol']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
								<!--<span>Se requiere un Nombre de Equipo.</span>-->
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<input type="text" class="form-control  form-control-sm" id="inputNombreA" minlength="1" placeholder="Ingrese un Nombre administrador" name="inputNombreA" value="<?php if(isset($inspeccion['nombre_admin'])): echo $inspeccion['nombre_admin']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
								<!--<span>Se requiere un Nombre de Equipo.</span>-->
							</div>
							<div class="form-group col-sm-6">
								<label for="inputRutA">RUT administrador</label>
								<input type="text" class="form-control  form-control-sm" id="inputRutA" minlength="1" placeholder="Ingrese un RUT administrador" name="inputRutA" value="<?php if(isset($inspeccion['rut_admin'])): echo $inspeccion['rut_admin']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
								<!--<span>Se requiere un Nombre de Equipo.</span>-->
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<input type="email" class="form-control  form-control-sm" id="inputEmailA" minlength="1" placeholder="Ingrese un Email administrador" name="inputEmailA" value="<?php if(isset($inspeccion['email_admin'])): echo $inspeccion['email_admin']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
								<!--<span>Se requiere un Nombre de Equipo.</span>-->
							</div>
							<!--<div class="form-group col-sm-6">
						...
						<div class="row">
							...
							<div class="form-group col-2 col-sm-2 pt-1">
								<div class="align-middle pt-2" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'hidden'; endif; ?>>
									<button href="SeleccionarEmpresa" class="btn btn-link align-middle text-center pt-4" type="button" id="btnBuscarEmpresa"  data-toggle="modal" data-target="#modalBuscarEmpresa" style="padding-top: 6px;" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
					...
					<div class="col-sm-12 mb-5">
						...
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<input type="text" class="form-control  form-control-sm" id="inputMarca" minlength="1" placeholder="Ingrese Marca del Ascensor" name="inputMarca" value="<?php if(isset($inspeccion['marca_ascensor'])): echo $inspeccion['marca_ascensor']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
							</div>
							<div class="form-group col-sm-6">
								<label for="selectUso">Uso</label>
								<select id="selectUso" name="selectUso" class="custom-select custom-select-sm" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'disabled="true"'; endif; ?>>
									<?php 
								 		if(isset($usos))
								 		{
						...
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<input type="number" class="form-control  form-control-sm" id="inputCapacidad" minlength="1" placeholder="Ingrese capacidad del Ascensor" name="inputCapacidad" value="<?php if(isset($inspeccion['capacidad_personas'])): echo $inspeccion['capacidad_personas']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
							</div>
							<div class="form-group col-sm-6">
								<label for="inputCapacidadKG">Capacidad en KG</label>
								<input type="number" class="form-control  form-control-sm" id="inputCapacidadKG" minlength="1" placeholder="Ingrese capacidad en KG" name="inputCapacidadKG" value="<?php if(isset($inspeccion['capacidad_kg'])): echo $inspeccion['capacidad_kg']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<select id="selectSuspension" name="selectSuspension" class="custom-select custom-select-sm" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'disabled="true"'; endif; ?>>
							...
							<div class="form-group col-sm-6">
								<label for="selectSalaMaquina">Sala de Maquinas</label>
								  <select id="selectSalaMaquina" name="selectSalaMaquina" class="custom-select custom-select-sm" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'disabled="true"'; endif; ?>>
						...
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<input type="text" class="form-control  form-control-sm" id="inputVelocidad" minlength="1" placeholder="Ingrese Velocidad" name="inputVelocidad" value="<?php if(isset($inspeccion['velocidad'])): echo $inspeccion['velocidad']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
							</div>
							<div class="form-group col-sm-6">
								<label for="inputRecorrido">Recorrido</label>
								<input type="text" class="form-control  form-control-sm" id="inputRecorrido" minlength="1" placeholder="Ingrese Recorrido" name="inputRecorrido" value="<?php if(isset($inspeccion['recorrido'])): echo $inspeccion['recorrido']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<input type="text" class="form-control  form-control-sm" id="inputParadas" minlength="1" placeholder="Ingrese Paradas" name="inputParadas" value="<?php if(isset($inspeccion['paradas'])): echo $inspeccion['paradas']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
							</div>
							<div class="form-group col-sm-6">
								<label for="selectTipoTraccion">Tipo Tracción</label>
								<select id="selectTipoTraccion" name="selectTipoTraccion" class="custom-select custom-select-sm" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'disabled="true"'; endif; ?>>
						...
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<input type="text" class="form-control  form-control-sm" id="inputCantidad" minlength="1" placeholder="Ingrese Cantidad" name="inputCantidad" value="<?php if(isset($inspeccion['cantidad'])): echo $inspeccion['cantidad']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
							</div>
							<div class="form-group col-sm-6">
								<label for="inputDiamCablesTraccion">Diametro de Traccion</label>
								<input type="text" class="form-control  form-control-sm" id="inputDiamTraccion" minlength="1" placeholder="Ingrese Diametro de Traccion" name="inputDiamTraccion" value="<?php if(isset($inspeccion['diametro_traccion'])): echo $inspeccion['diametro_traccion']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-sm-6">
								<label for="inputEnclavamientoElectrico">Enclavamiento El&eacute;ctrico Limitador</label>
								<input type="text" class="form-control  form-control-sm" id="inputEnclavamientoElectrico" minlength="1" placeholder="Ingrese Enclavamiento Electrico Limitador" name="inputEnclavamientoElectrico" value="<?php if(isset($inspeccion['enclavamiento_electrico'])): echo $inspeccion['enclavamiento_electrico']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
							</div>
							<div class="form-group col-sm-6">
								<label for="inputEnclavamientoMecanico">Enclavamiento Mec&aacute;nico Limitador</label>
								<input type="text" class="form-control  form-control-sm" id="inputEnclavamientoMecanico" minlength="1" placeholder="Ingrese Enclavamiento Electrico Limitador" name="inputEnclavamientoMecanico" value="<?php if(isset($inspeccion['enclavamiento_mecanico'])): echo $inspeccion['enclavamiento_mecanico']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
							</div>
						</div>
						<div class="row">
							<div class="form-group col-sm-6">
								<label for="inputDiamCableLimitador">Diametro Cable Limitador</label>
								<input type="text" class="form-control  form-control-sm" id="inputDiamCableLimitador" minlength="1" placeholder="Ingrese Diametro Cable Limitador" name="inputDiamCableLimitador" value="<?php if(isset($inspeccion['diametro_cable'])): echo $inspeccion['diametro_cable']; endif; ?>" <?php  if(isset($inspeccion['reinspeccion']) && $inspeccion['reinspeccion'] == 1): echo 'readonly'; endif; ?>>
							</div>
						</div>
									    ...
									    <fieldset id="front">        
									            ...
									            <div class="row">
									            	<div class="col-sm-12 text-center mt-3">
												    	...
												    	<a href="#" class="btn btn-primary upload-photo">
