...
<div class="row pt-3">
	<div class="col-sm-12">
		<div class="row">
			<div class="col-sm-7 mt-3">
				<h3 class="pl-3"><i class="plusTitulo mb-2" data-feather="list" ></i> Lista de Categorias
				</h3>
			</div>
		</div>
	...
	<div id="agregarCategoria" class="col-sm-12 text-right">
		<a href="agregarCategoria" class="btn btn-link"><i stop-color data-feather="plus" class="pb-1"></i>Agregar Categoria</a>
	</div>
</div>
<div class="row p-3">
				        ...
				        foreach ($categorias as $categoria): ?>
				  			<tr>
					        	...
					        	<td class="text-center align-middle registro botonTabla">
						        	<a id="edit_<?php echo $categoria['id']; ?>" class="view_convenio" href="ModificarCategoria/?idCategoria=<?php echo $categoria['id']; ?>">
						        		<i data-feather="edit-3" data-toggle="tooltip" data-placement="top" title="Modificar"></i>       		
					        		</a>
					        	</td>
					        	<td class="text-center align-middle registro botonTabla">
					        		<?php if ($categoria["estado"] == "1") { ?>
						        					<a id="trash_<?php echo $categoria['id']; ?>" class="trash" href="#" data-toggle="modal" data-target="#modalEliminarCategoria" data-id="<?php echo $categoria['id']; ?>" data-categoria="<?php echo $categoria['nombre']; ?>">
										        		<i data-feather="trash-2" data-toggle="tooltip" data-placement="top" title="Eliminar"></i>       		
									        		</a>
					        		<?php }else{ ?>
					        						<a id="trash_<?php echo $categoria['id']; ?>" class="trash" href="#" data-toggle="modal" data-target="#modalActivarCategoria" data-id="<?php echo $categoria['id']; ?>" data-categoria="<?php echo $categoria['nombre']; ?>">
	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h5 class="modal-title" id="tituloEC" name="tituloEC" data-idcategoria="" data-categoria=""> Eliminar Categoria</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="modal-body">
			<p id="parrafoEC">¿Esta seguro que deseas Eliminar el Categoria?</p>
	      </div>
	      <div class="modal-footer">
...
<!-- Modal Activar -->
	<div class="modal fade" id="modalActivarCategoria" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	      	<i class="plusTitulo mb-2" data-feather="check-circle"></i>
	        <h5 class="modal-title" id="tituloAP" name="tituloAP" data-idcategoria="" data-categoria=""> Activar Categoria</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="modal-body">
			<p id="parrafoAP" name="parrafoAP">¿Esta seguro que deseas Activar el Categoria?</p>
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-primary" data-dismiss="modal">Cancelar</button>
	        <button id="activarCategoria" type="button" class="btn btn-success">Activar</button>
	      </div>
	    </div>
	  </div>
	</div>
